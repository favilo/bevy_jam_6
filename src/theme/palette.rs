...
pub const LABEL_TEXT: Color = Color::Srgba(SEASHELL);

/// #fcfbcc
// pub const HEADER_TEXT: Color = Color::srgb(0.988, 0.984, 0.800);
pub const HEADER_TEXT: Color = Color::Srgba(SNOW);
...
pub const BUTTON_DISABLED_BACKGROUND: Color = Color::Srgba(SLATE_GRAY);
